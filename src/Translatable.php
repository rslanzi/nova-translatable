...
use Rslanzi\NovaTranslatable\Exceptions\InvalidConfiguration;
...
class Translatable extends MergeValue
{
    ...
    /** @var boolean */
    protected $groupsFieldsIntoPanels = false;
    ...
    public function groupsFieldsIntoPanels(bool $value = true) {
        $this->groupsFieldsIntoPanels = $value;
    ...
    protected function createTranslatedField(Field $originalField, string $locale): Field
    {
        ...
        $translatedField
            ->resolveUsing(function ($value, Model $model) use ($translatedField, $locale, $originalAttribute) {
                ...
                $translatedField->panel = ($this->groupsFieldsIntoPanels ? $locale : $this->panel);
